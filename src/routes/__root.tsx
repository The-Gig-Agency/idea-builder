  ...
  head: () => ({
    meta: [
      ...
      { title: "MusicDNA — a catalog of revealing decisions" },
      {
        name: "description",
        content:
          "MusicDNA isn't a recommendation app. It's a self-discovery platform that uses music as the input layer.",
      },
      { name: "theme-color", content: "#111315" },
      { property: "og:title", content: "MusicDNA" },
      {
        property: "og:description",
        content: "A catalog of revealing decisions. Music is the language. Identity is the destination.",
      },
